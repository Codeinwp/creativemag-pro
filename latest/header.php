	...
	<header id="masthead" class="site-header" role="banner">
			<div id="header">
				...
				<div class="nav-block">
					...
					<?php if(trim($creativemag_options['CMfb']) != '' || trim($creativemag_options['CMtw']) != '' ||  trim($creativemag_options['CMrss']) != '' || trim($creativemag_options['CMgplus']) != '' ) { ?>
                    <ul class="social">
						...
						<?php if(trim($creativemag_options['CMgplus']) != '') { ?><li><a href="<?php echo $creativemag_options['CMgplus']; ?>"  class="gplus" >gplus</a></li> <?php } ?> 
						<?php if(trim($creativemag_options['CMpinterest']) != '') { ?><li><a href="<?php echo $creativemag_options['CMpinterest']; ?>"  class="pinterest" >pinterest</a></li> <?php } ?> 
					</ul>
